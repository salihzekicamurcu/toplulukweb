...
else
{
	...
	include("db_baglan.php");
			$SQL_tumuyeler="select * from  tablo_duyuru where DuyuruID='$id'";
			...
			if($sorgu_tumuyeler)
			{
				...
				{	
							...
							echo'<tr><td><h3><u>'.$veri['DuyuruBaslik'].'</u></h3></td></tr>';
							echo'<tr><td><img width="auto" height="300px" src="'.$resimLink.'"/></td></tr>';
							echo'<tr><td>Duyuru Tarihi:'.$veri['DuyuruTarih'].'</td></tr>';
							echo'<tr><td ><br><br>'.$veri['DuyuruMetni'].'</td></tr>';							
