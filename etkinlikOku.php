...
else
{
	...
	include("db_baglan.php");
			$SQL_tumuyeler="select * from  tablo_etkinlikler where EtkinlikID='$id'";
			...
			if($sorgu_tumuyeler)
			{
				...
				{	
							...
							echo'<tr><td><h3><u>'.$veri['EtkinlikBaslik'].'</u></h3></td></tr>';
							echo'<tr><td><img width="auto" height="300px" src="'.$resimLink.'"/></td></tr>';
							echo'<tr><td>Etkinlik Tarihi:'.$veri['EtkinlikTarih'].'</td></tr>';
							echo'<tr><td ><br><br>'.$veri['EtkinlikMetni'].'</td></tr>';							
