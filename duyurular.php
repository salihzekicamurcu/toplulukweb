        ...
        <ul>
            ...
            <li><a href="">Galeri</a>
				<ul>
				 ...
				 <li><a href="galeri.php?menu=videoGaleri">Video Galeri</a></li>
...
<?php
		if(isset($_GET['sayfa']))
			...
			*/
			...
			$SQL_tumuyeler="select * from  tablo_duyuru order by DuyuruID DESC";
			...
			if($sorgu_tumuyeler)
			{
				...
				{	$sayac++;	
					...
					{
							$resimLink='img/duyuru.png';

						
							echo'<fieldset><form><table >';
							echo'<tr><td><h3>'.$veri['DuyuruBaslik'].'</h3></td></tr>';
							echo'<tr><td>Duyuru Tarihi:<u>'.$veri['DuyuruTarih'].'</u></td></tr>';
							echo'<tr><td >'.substr($veri['DuyuruMetni'],0,80).'..</td></tr>';							
	...
	*/
			...
			if($sorgu)
			{
				...
				*/
				...
				for($i=1;$i<=$sayfa;$i++)
				{
				 echo'<a href="duyurular.php?sayfa='.$i.'">'.$i.'</a>';
				}
				echo'</div>';
			}
?>
